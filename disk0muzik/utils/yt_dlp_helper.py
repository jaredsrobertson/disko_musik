...
class YouTubeDLClient:
    ...
    def extract_info(self, query: str) -> Optional[Dict[str, str]]:
        try:
...
# Initialize the YouTubeDL client
yt_dlp_client = YouTubeDLClient()


def extract_youtube_info(query: str) -> Optional[Dict[str, str]]:
    return yt_dlp_client.extract_info(query)
